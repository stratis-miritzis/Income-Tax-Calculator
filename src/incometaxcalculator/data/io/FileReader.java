...
public abstract class FileReader {
  ...
  abstract String getValues(String fieldsLine);
  public abstract int checkForReceipt(BufferedReader inputStream) throws NumberFormatException, IOException;
  
//  abstract int getReceiptID(String values[]); 
...
//  }
  ...
  public String getValueOfField(String fieldsLine) throws WrongFileFormatException {
    ...
    try {
      String value = getValues(fieldsLine);
      return value;
